                ...
                <div class="card modern-card">
                    ...
                    <div class="card-body modern-body">
                        ...
                        <div class="add-button-wrapper">
                            <a href="{{ route('dashboard.categories.create') }}" class="btn-add-modern">
                            ...
                            <table class="table modern-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-hover">
                                        ...
                                        <td>
                                            <span class="book-title-text">{{ $category->name }}</span>
                                        </td>
                                                               <td>
<a href="{{ url('admin/dashboard/categories/' . $category->id) }}" 
   class="text-primary text-decoration-none">
    {{ $category->books_count ?? 0 }} <!-- ليس $author -->
</a>
</td>
                                        <td>
                                            ...
                                            <div class="action-buttons-group">
                                                ...
                                                <form action="{{ route('dashboard.categories.destroy', $category->id) }}" 
                                                    ...
                                                    <button type="submit" 
                                                            ...
                                                            title="حذف"
                                                            onclick="return confirm('هل أنت متأكد من حذف الكتاب {{ $category->title }}؟')">
