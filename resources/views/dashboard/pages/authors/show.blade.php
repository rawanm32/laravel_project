                ...
                <div class="card modern-card">
                    <div class="card-header modern-header">
                        <div class="header-left">
                            ...
                            <div class="header-text">
                                ...
                                <p class="card-subtitle">إدارة مكتبة الكتب</p>
                            </div>
                        </div>
                    ...
                    <div class="card-body modern-body">
                        ...
                        <div class="add-button-wrapper">
                            <a href="{{ route('dashboard.books.create') }}" class="btn-add-modern">
                                        ...
                                        <td>
                                            @if($book->compare_price && $book->compare_price > $book->price)
                                                <div class="price-wrapper">
                                                    <span class="old-price">{{ number_format($book->compare_price, 2) }}</span>
                                                    <span class="new-price">{{ number_format($book->price, 2) }}</span>
                                                    <span class="discount-badge">خصم</span>
                                                </div>
                                            @else
                                                <span class="normal-price">{{ number_format($book->price, 2) }}</span>
                                            @endif
                                        </td>
                                            ...
                                            <div class="action-buttons-group">
                                                ...
                                                <form action="{{ route('dashboard.books.destroy', $book->id) }}" 
                                                    ...
                                                    <button type="submit" 
                                                            ...
                                                            title="حذف"
                                                            onclick="return confirm('هل أنت متأكد من حذف الكتاب {{ $book->title }}؟')">
