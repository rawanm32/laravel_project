                ...
                <div class="card modern-card">
                    ...
                    <div class="card-body modern-body">
                        ...
                        <div class="add-button-wrapper">
                            <a href="{{ route('dashboard.authors.create') }}" class="btn-add-modern">
                            ...
                            <table class="table modern-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-hover">
                                        ...
                                        <td>
                                            <span class="book-title-text">{{ $author->name }}</span>
                                        </td>
                                ...
                                <td>
<a href="{{ url('admin/dashboard/authors/' . $author->id) }}" 
                                            ...
                                            <div class="action-buttons-group">
                                                ...
                                                <form action="{{ route('dashboard.authors.destroy', $author->id) }}" 
                                                    ...
                                                    <button type="submit" 
                                                            ...
                                                            title="حذف"
                                                            onclick="return confirm('هل أنت متأكد من حذف الكتاب {{ $author->title }}؟')">
